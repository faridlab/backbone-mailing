//! Domain policy for MailingContact aggregate
//!
...
/// Domain policy for MailingContact — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailingContact>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailingContactDomainPolicy = PermitAllPolicy<MailingContact>;
