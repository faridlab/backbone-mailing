//! Domain policy for Mailing aggregate
//!
...
/// Domain policy for Mailing — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Mailing>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailingDomainPolicy = PermitAllPolicy<Mailing>;
