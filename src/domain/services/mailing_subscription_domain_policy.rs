//! Domain policy for MailingSubscription aggregate
//!
...
/// Domain policy for MailingSubscription — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailingSubscription>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailingSubscriptionDomainPolicy = PermitAllPolicy<MailingSubscription>;
