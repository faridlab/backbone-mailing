//! Specifications for MailingAbTest aggregate
//!
...
// Each predicate implements `Specification<MailingAbTest>` and can be combined
...
//
// pub struct ActiveMailingAbTestSpec;
// impl Specification<MailingAbTest> for ActiveMailingAbTestSpec {
//     fn is_satisfied_by(&self, e: &MailingAbTest) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
