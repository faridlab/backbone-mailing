//! Specifications for MailingContact aggregate
//!
...
// Each predicate implements `Specification<MailingContact>` and can be combined
...
//
// pub struct ActiveMailingContactSpec;
// impl Specification<MailingContact> for ActiveMailingContactSpec {
//     fn is_satisfied_by(&self, e: &MailingContact) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
