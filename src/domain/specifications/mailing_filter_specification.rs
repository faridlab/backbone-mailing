//! Specifications for MailingFilter aggregate
//!
...
// Each predicate implements `Specification<MailingFilter>` and can be combined
...
//
// pub struct ActiveMailingFilterSpec;
// impl Specification<MailingFilter> for ActiveMailingFilterSpec {
//     fn is_satisfied_by(&self, e: &MailingFilter) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
