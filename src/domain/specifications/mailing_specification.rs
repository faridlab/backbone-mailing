//! Specifications for Mailing aggregate
//!
...
// Each predicate implements `Specification<Mailing>` and can be combined
...
//
// pub struct ActiveMailingSpec;
// impl Specification<Mailing> for ActiveMailingSpec {
//     fn is_satisfied_by(&self, e: &Mailing) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
