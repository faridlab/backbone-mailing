//! Specifications for MailingTrace aggregate
//!
...
// Each predicate implements `Specification<MailingTrace>` and can be combined
...
//
// pub struct ActiveMailingTraceSpec;
// impl Specification<MailingTrace> for ActiveMailingTraceSpec {
//     fn is_satisfied_by(&self, e: &MailingTrace) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
