//! Specifications for OptOutReason aggregate
//!
...
// Each predicate implements `Specification<OptOutReason>` and can be combined
...
//
// pub struct ActiveOptOutReasonSpec;
// impl Specification<OptOutReason> for ActiveOptOutReasonSpec {
//     fn is_satisfied_by(&self, e: &OptOutReason) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
